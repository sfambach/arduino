...
DELAY_START - Delay at the begining between led switches
...
#define DELAY_START 10 // ms
#define FRICTION 0.02 //ms
...
void throwBall(){
  ...
  float delay_cur = DELAY_START;
  float friction_cur = FRICTION;
  ...
  while(run){
    ...
    // calculate delay
    friction_cur = friction_cur + FRICTION;
    delay_cur = delay_cur + friction_cur;
