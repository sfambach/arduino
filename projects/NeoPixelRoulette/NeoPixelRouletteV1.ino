...
SPEED_VARIANCE - By wich value could the start speed varie +/-

## Calculation basis 
Lets make a littel bit physics: 
* we have a ball with speed Vs(tart)
* we have a friction between roulette and ball this is causing a nagativ acceleration a
* we need the speed at time point tp(oint)

The formula for this is:
s = Vs * tp + 0.5 *  a * tp²

Now we have the speed of the ball but what does this mean for the light :(
first assumtion this is the speed how fast the next led is switched on
