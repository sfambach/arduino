...
#if defined(_ADAFRUIT_ST7789H_) // 240x320 TFT
    #define TFT_MOSI 23  // Data out (SDA)
    #define TFT_SCLK 18  // Clock out (SCL)
    eye[e].display     = new displayType( eyeInfo[e].select,
                                         DISPLAY_DC, TFT_MOSI, TFT_SCLK, DISPLAY_RESET);
