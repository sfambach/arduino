...
#else
  {  5, -1, 0 }, // LEFT EYE display-select and wink pins, no rotation
...
// DISPLAY HARDWARE SETTINGS (screen type & connections) -------------------
  ...
  #else
    #define DISPLAY_DC       16  // Data/command pin for ALL displays
    #define DISPLAY_RESET    17  // Reset pin for ALL displays
    #define TFT_MOSI 23  // Data out (SDA)
    #define TFT_SCLK 18  // Clock out (SCL)
    //#define DISPLAY_BACKLIGHT 25
    //#define BACKLIGHT_MAX    255
  #endif
#endif
