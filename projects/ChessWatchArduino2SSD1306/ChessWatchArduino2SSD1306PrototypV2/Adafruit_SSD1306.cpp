...
static uint8_t  *Adafruit_SSD1306::buffer= NULL;
...
Adafruit_SSD1306::Adafruit_SSD1306(uint8_t w, uint8_t h, TwoWire *twi,
  ...
  Adafruit_GFX(w, h), spi(NULL), wire(twi ? twi : &Wire),
...
Adafruit_SSD1306::Adafruit_SSD1306(uint8_t w, uint8_t h,
  ...
  int8_t cs_pin) : Adafruit_GFX(w, h), spi(NULL), wire(NULL),
...
Adafruit_SSD1306::Adafruit_SSD1306(int8_t mosi_pin, int8_t sclk_pin,
  ...
  mosiPin(mosi_pin), clkPin(sclk_pin), dcPin(dc_pin),
...
Adafruit_SSD1306::Adafruit_SSD1306(int8_t dc_pin, int8_t rst_pin,
  ...
  spi(&SPI), wire(NULL), mosiPin(-1), clkPin(-1),
...
boolean Adafruit_SSD1306::begin(uint8_t vcs, uint8_t addr, boolean reset,
  ...
  if(!buffer){
    Serial.print(".. buffer is empty .. allocate ram ");
